...
export const metadata: Metadata = {
  ...
  description: 'Free, open-source online booking for independent stylists, home salons and chair renters.',
  ...
  openGraph: {
    ...
    description: 'Free, open-source online booking for independent stylists, home salons and chair renters.',
    images: [{ url: '/opengraph-image', width: 1200, height: 630, alt: 'SoloSalon — Your bookings. Your business.' }],
  },
  twitter: {
